...
class TemporaryAddressScreen extends StatefulWidget {
  static const routeName = '/temporary-address-screen';
  const TemporaryAddressScreen({Key? key}) : super(key: key);

  @override
  _TemporaryAddressScreenState createState() => _TemporaryAddressScreenState();
}
...
class _TemporaryAddressScreenState extends State<TemporaryAddressScreen> {
  ...
  void _saveForm(context) {
    ...
    Navigator.of(context).pushNamed(VehicleInformationScreen.routeName);
  }
